...
| - [Data provenance](#data-provenance)             |  - [List of collected papers](/data-collection/collected-papers.md)   | - The complete artifact package: `VasconcelosEtAl-2026-artifact.zip`              |
...
| - [Licenses](#licenses)                           | - [FSE Timeline](/data-collection/FSE-conference-website-data.md) |  - Generated outputs of this artifact: `outputs/`  |
| - [Reproduction](#reproduction)                   | - [ICSE Timeline](/data-collection/ICSE-conference-website-data.md) | - Expected outputs of this artifact: `outputs/expected-outputs/` |
