	...
	if( !em_maps_loaded ){
		if ( jQuery('script#google-maps').length == 0 && ( typeof google !== 'object' || typeof google.maps !== 'object' ) ){ 
			...
			if( typeof EM.google_maps_api !== 'undefined' ){
				script.src = proto + '//web.archive.org/web/20170927135355/http://maps.google.com/maps/api/js?v=3&libraries=places&callback=em_maps&key='+EM.google_maps_api;
			}else{
				script.src = proto + '//web.archive.org/web/20170927135355/http://maps.google.com/maps/api/js?v=3&libraries=places&callback=em_maps';
			}
			document.body.appendChild(script);
...
/*
     FILE ARCHIVED ON 13:53:55 Sep 27, 2017 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 14:10:46 May 13, 2025.
...
/*
playback timings (ms):
  captures_list: 1.13 (2)
  exclusion.robots: 0.047 (2)
  exclusion.robots.policy: 0.027 (2)
  esindex: 0.026 (2)
  cdx.remote: 56.854 (2)
  LoadShardBlock: 150.732 (6)
  PetaboxLoader3.datanode: 169.102 (8)
  load_resource: 234.988 (2)
  PetaboxLoader3.resolve: 129.358
*/