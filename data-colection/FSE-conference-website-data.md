...
- [**(F01)** CfA invites authors of accepted Research papers to submit artifacts](#f01-cfa-invites-authors-of-accepted-research-papers-to-submit-artifacts) <br>

- [**(F02)** CfA invites authors of accepted Industrial papers to submit artifacts](#f02-cfa-invites-authors-of-accepted-industrial-papers-to-submit-artifacts) <br>

- [**(F03)** CfA invites authors of any prior SE papers to submit artifacts whose results were validated in other studies](#f03-cfa-invites-authors-of-any-prior-se-papers-to-submit-artifacts-whose-results-were-validated-in-other-studies) <br>

- [**(F04)** FSE classifies artifacts as Diamond, Platinum, and Gold](#f04-fse-classifies-artifacts-as-diamond-platinum-and-gold) <br>

- [**(F05)** Artifact-evaluated badges are included on the front page of the papers](#f05-artifact-evaluated-badges-are-included-on-the-front-page-of-the-papers) <br>

- [**(F06)** FSE adopts ACM Badges](#f06-fse-adopts-acm-badges) <br>

- [**(F07)** CfA announces visibility rewards for artifacts successfully evaluated](#f07-cfa-announces-visibility-rewards-for-artifacts-successfully-evaluated) <br>

- [**(F08)** CfA announces Best Artifact Awards](#f08-cfa-announces-best-artifact-awards) <br>


- [**(F09)** Authors of papers with accepted artifacts benefit from five more minutes of presentation at the conference](#f09-authors-of-papers-with-accepted-artifacts-benefit-from-five-more-minutes-of-presentation-at-the-conference) <br>

- [**(F10)** CfA states that accepted artifacts are stored in the ACM Digital Library](#f10-cfa-states-that-accepted-artifacts-are-stored-in-the-acm-digital-library) <br>

- [**(F11)** CfA states that papers with accepted artifacts benefit from an extra page dedicated to the presentation of the artifacts](#f11-cfa-states-that-papers-with-accepted-artifacts-benefit-from-an-extra-page-dedicated-to-the-presentation-of-the-artifacts) <br>

- [**(F12)** CfA states that abstracts documenting accepted artifacts are to be published in the proceedings](#f12-cfa-states-that-abstracts-documenting-accepted-artifacts-are-to-be-published-in-the-proceedings) <br>

- [**(F13)** CfA states that authors of artifacts accepted as Results Validated may be invited to give lightning talks](#f13-cfa-states-that-authors-of-artifacts-accepted-as-results-validated-may-be-invited-to-give-lightning-talks) <br>

- [**(F14)** CfA states that authors of artifacts accepted as Artifact Evaluated may be invited to give lightning talks](#f14-cfa-states-that-authors-of-artifacts-accepted-as-artifact-evaluated-may-be-invited-to-give-lightning-talks) <br>

- [**(F15)** Research track CfP asks authors not to provide URLs to author-revealing sites due to the double-anonymous review process](#f15-research-track-cfp-asks-authors-not-to-provide-urls-to-author-revealing-sites-due-to-the-double-anonymous-review-process) <br>

- [**(F16)** Research track CfP states that authors can submit an additional file containing supplementary material](#f16-research-track-cfp-states-that-authors-can-submit-an-additional-file-containing-supplementary-material) <br>

- [**(F17)** Research track CfP encourages authors to submit a link to anonymous artifacts](#f17-research-track-cfp-encourages-authors-to-submit-a-link-to-anonymous-artifacts) <br>

- [**(F18)** Research track CfP encourages authors to make artifacts available upon paper submission or explain why not](#f18-research-track-cfp-encourages-authors-to-make-artifacts-available-upon-paper-submission-or-explain-why-not) <br>

- [**(F19)** FSE asks authors to declare artifact availability in the papers, ideally, in a section named Data Availability](#f19-fse-asks-authors-to-declare-artifact-availability-in-the-papers-ideally-in-a-section-named-data-availability) <br>

- [**(F20)** Research track CfP states that reviewers will not necessarily consider any materials in the paper review process](#f20-research-track-cfp-states-that-reviewers-will-not-necessarily-consider-any-materials-in-the-paper-review-process) <br>

- [**(F21)** Open Science policies are provided on the FSE website](#f21-open-science-policies-are-provided-on-the-fse-website) <br>

- [**(F22)** FSE adheres to the ACM SIGSOFT Open Science Policies](#f22-fse-adheres-to-the-acm-sigsoft-open-science-policies) <br>

- [**(F23)** FSE provides a guide to disclose data for double-anonymous peer review and make it open upon paper acceptance](#f23-fse-provides-a-guide-to-disclose-data-for-double-anonymous-peer-review-and-make-it-open-upon-paper-acceptance) <br>

- [**(F24)** FSE provides a guide to automatically archive a GitHub repository to Zenodo or Figshare](#f24-fse-provides-a-guide-to-automatically-archive-a-github-repository-to-zenodo-or-figshare) <br>

- [**(F25)** FSE hosts a ROSE Festival edition](#f25-fse-hosts-a-rose-festival-edition) <br>
...
|:------------------------------------------------------------------------------------------------------------------------------------:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|
|                            [F01](#f01-cfa-invites-authors-of-accepted-research-papers-to-submit-artifacts)                           |   X  |   X  |   X  |   X  |   X  |   X  |   X  |   X  |   X  |   X  |
|                           [F02](#f02-cfa-invites-authors-of-accepted-industrial-papers-to-submit-artifacts)                          |   -  |   -  |   -  |   -  |   -  |   -  |   -  |   -  |   X  |   X  |
|       [F03](#f03-cfa-invites-authors-of-any-prior-se-papers-to-submit-artifacts-whose-results-were-validated-in-other-studies)       |   -  |   -  |   -  |   -  |   -  |   -  |   X  |   X  |   X  |   X  |
|                                   [F04](#f04-fse-classifies-artifacts-as-diamond-platinum-and-gold)                                  |   -  |   -  |   X  |   -  |   -  |   -  |   -  |   -  |   -  |   -  |
|                          [F05](#f05-artifact-evaluated-badges-are-included-on-the-front-page-of-the-papers)                          |   -  |   -  |   X  |   X  |   X  |   X  |   X  |   X  |   X  |   X  |
|                                                   [F06](#f06-fse-adopts-acm-badges)                                                  |   -  |   -  |   -  |   X  |   X  |   X  |   X  |   X  |   X  |   X  |
|                           [F07](#f07-cfa-announces-visibility-rewards-for-artifacts-successfully-evaluated)                          |   X  |   -  |   X  |   X  |   -  |   X  |   -  |   -  |   -  |   -  |
|                                            [F08](#f08-cfa-announces-best-artifact-awards)                                            |   X  |   -  |   X  |   -  |   -  |   -  |   X  |   X  |   X  |   X  |
|        [F09](#f09-authors-of-papers-with-accepted-artifacts-benefit-from-five-more-minutes-of-presentation-at-the-conference)        |   -  |   X  |   -  |   -  |   -  |   -  |   -  |   -  |   -  |   -  |
|                         [F10](#f10-cfa-states-that-accepted-artifacts-are-stored-in-the-acm-digital-library)                         |   -  |   X  |   -  |   -  |   -  |   -  |   -  |   -  |   -  |   -  |
| [F11](#f11-cfa-states-that-papers-with-accepted-artifacts-benefit-from-an-extra-page-dedicated-to-the-presentation-of-the-artifacts) |   -  |   X  |   X  |   X  |   -  |   -  |   -  |   -  |   -  |   -  |
|              [F12](#f12-cfa-states-that-abstracts-documenting-accepted-artifacts-are-to-be-published-in-the-proceedings)             |   -  |   -  |   -  |   -  |   -  |   -  |   -  |   X  |   -  |   -  |
|         [F13](#f13-cfa-states-that-authors-of-artifacts-accepted-as-results-validated-may-be-invited-to-give-lightning-talks)        |   -  |   -  |   -  |   -  |   -  |   -  |   X  |   X  |   X  |   X  |
|        [F14](#f14-cfa-states-that-authors-of-artifacts-accepted-as-artifact-evaluated-may-be-invited-to-give-lightning-talks)        |   -  |   -  |   -  |   -  |   -  |   -  |   X  |   -  |   X  |   -  |
| [F15](#f15-research-track-cfp-asks-authors-not-to-provide-urls-to-author-revealing-sites-due-to-the-double-anonymous-review-process) |   -  |   -  |   -  |   X  |   X  |   X  |   X  |   X  |   X  |   X  |
|          [F16](#f16-research-track-cfp-states-that-authors-can-submit-an-additional-file-containing-supplementary-material)          |   -  |   -  |   -  |   -  |   X  |   X  |   X  |   X  |   X  |   -  |
|                       [F17](#f17-research-track-cfp-encourages-authors-to-submit-a-link-to-anonymous-artifacts)                      |   -  |   -  |   -  |   -  |   -  |   X  |   X  |   X  |   X  |   -  |
|        [F18](#f18-research-track-cfp-encourages-authors-to-make-artifacts-available-upon-paper-submission-or-explain-why-not)        |   -  |   -  |   -  |   -  |   -  |   X  |   X  |   X  |   X  |   X  |
|       [F19](#f19-fse-asks-authors-to-declare-artifact-availability-in-the-papers-ideally-in-a-section-named-data-availability)       |   -  |   -  |   -  |   -  |   -  |   X  |   X  |   X  |   -  |   X  |
|     [F20](#f20-research-track-cfp-states-that-reviewers-will-not-necessarily-consider-any-materials-in-the-paper-review-process)     |   -  |   -  |   -  |   -  |   X  |   X  |   X  |   X  |   X  |   -  |
|                                   [F21](#f21-open-science-policies-are-provided-on-the-fse-website)                                  |   -  |   -  |   -  |   -  |   -  |   X  |   X  |   X  |   -  |   X  |
|                                   [F22](#f22-fse-adheres-to-the-acm-sigsoft-open-science-policies)                                   |   -  |   -  |   -  |   -  |   -  |   -  |   -  |   -  |   -  |   X  |
|       [F23](#f23-fse-provides-a-guide-to-disclose-data-for-double-anonymous-peer-review-and-make-it-open-upon-paper-acceptance)      |   -  |   -  |   -  |   -  |   -  |   X  |   X  |   X  |   X  |   X  |
|                  [F24](#f24-fse-provides-a-guide-to-automatically-archive-a-github-repository-to-zenodo-or-figshare)                 |   -  |   -  |   -  |   -  |   -  |   -  |   -  |   -  |   -  |   X  |
|                                             [F25](#f25-fse-hosts-a-rose-festival-edition)                                            |   -  |   -  |   -  |   -  |   X  |   X  |   X  |   X  |   -  |   -  |
...
## (F01) CfA invites authors of accepted Research papers to submit artifacts
...
[PDF](FSE-websites/FSE2014-RT.pdf)<br>
...
[PDF](FSE-websites/FSE2015-RPT.pdf) <br>
...
[PDF](FSE-websites/FSE2016-AT.pdf) <br>
...
[PDF](FSE-websites/FSE2017-AET.pdf) <br>
...
[PDF](FSE-websites/FSE2018-AT.pdf) <br>
...
[PDF](FSE-websites/FSE2019-AT.pdf) <br>
Breadcrumb: ESEC/FSE 2019 > Calls > Artifacts > Call For Papers
<br><br>


> Out of the 74 accepted research track papers (each eligible to submit to the artifacts track), 21 artifact submissions were received, ranging from data sets to benchmarks or tools.

[Direct link](https://dl.acm.org/action/showFmPdf?doi=10.1145%2F3338906) - 
[PDF](FSE-websites/FSE2019-FM.pdf) <br>
Breadcrumb: ACM Digital Library > ESEC/FSE 2019 > Proceeding Downloads > Front matter
<br><br>
...
[PDF](FSE-websites/FSE2020-AT.pdf) <br>
...
[PDF](FSE-websites/FSE2021-AT.pdf) <br>
...
[PDF](FSE-websites/FSE2022-AT.pdf) <br>
...
[PDF](FSE-websites/FSE2023-AT.pdf) <br>
...
## (F02) CfA invites authors of accepted Industrial papers to submit artifacts
...
## (F03) CfA invites authors of any prior SE papers to submit artifacts whose results were validated in other studies
...
## (F04) FSE classifies artifacts as Diamond, Platinum, and Gold
...
<table style="width:100%; border-collapse:collapse;">
  <tr>
    <td style="width:20%; border:1px solid #ddd; padding:10px; vertical-align:center;">
      Diamond
    </td>
    <td style="border:1px solid #ddd; padding:10px; vertical-align:top;">
      Award winning: most insightful, useful, and usable artifacts. Diamond artifacts will be given awards at a public session at FSE 2016, mentioned as part of the social media campaign for FSE 2016, and cataloged in an online repository.
    </td>
  </tr>
  <tr>
  <td style="width:20%; border:1px solid #ddd; padding:10px; vertical-align:center;">
    ...
    <td style="border:1px solid #ddd; padding:10px; vertical-align:top;">
    Very good: insightful, useful, and usable artifacts. Platinum artifacts will be mentioned as part of the social media campaign for FSE 2016 and cataloged in an online repository.
    </td>
  </tr>
  <tr>
  <td style="width:20%; border:1px solid #ddd; padding:10px; vertical-align:center;">
  ...
  <td style="border:1px solid #ddd; padding:10px; vertical-align:top;">
  Potentially insightful, useful, or usable artifacts. Gold artifacts will be cataloged in an online repository.
  </td>
  </tr>
</table>
<br>
...
## (F05) Artifact-evaluated badges are included on the front page of the papers
...
> - We will work with the IEEE Xplore and ACM Portal administrator to add badges to the electronic versions of the paper related to the artifact.


[Direct link](https://2021.esec-fse.org/track/fse-2021-artifacts) - 
[PDF](FSE-websites/FSE2021-AT.pdf) <br>
Breadcrumb: ESEC/FSE 2021 > Tracks > Artifacts > FSE 2021 Artifact Track: Call for Submissions > Badges in More Detail
<br><br>

Besides this unclear information, there is not specific information about this event at ESEC/FSE 2021 website, but nevertheless papers whose artifacts were successfully evaluated received an ACM badge on their first page. For instance: [FP0227], [FP0228], [FP0230], [FP0231], [FP0232], [FP0236], [FP0237], [FP0239], [FP0240], and [FP0241].
<br><br>
...
## (F07) CfA announces visibility rewards for artifacts successfully evaluated
...
[PDF](FSE-websites/FSE2017-FM.pdf) <br>
...
> Any research track paper with an accepted artifact is being highlighted in the conference program.
...
## (F08) CfA announces Best Artifact Awards

### 2014

> To recognize the contribution of a significant and high-quality research artifact, the program committee will select one of the accepted papers to receive a "Best Artifact Award".
...
[Direct link](https://2020.esec-fse.org/track/esecfse-2020-artifacts) - 
[PDF](FSE-websites/FSE2020-AT.pdf) <br>
Breadcrumb: ESEC/FSE 2020 > Tracks > Artifacts > Best Artifact Awards
<br><br>


### 2021

> The top two artifacts selected by the Program Committee will be awarded the best artifact awards.
...
[Direct link](https://2022.esec-fse.org/track/fse-2022-artifacts) - 
[PDF](FSE-websites/FSE2022-AT.pdf) <br>
Breadcrumb: ESEC/FSE 2022 > Tracks > Artifacts > Call for Submissions > Best Artifact Awards
<br><br>


### 2023

> There will be two ESEC/FSE 2023 Best Artifact Awards to recognize the effort of authors creating and sharing outstanding research artifacts.

[Direct link](https://2023.esec-fse.org/track/fse-2023-artifacts) - 
[PDF](FSE-websites/FSE2023-AT.pdf) <br>
Breadcrumb: ESEC/FSE 2023 > Tracks > Artifacts > Call for Submissions > Best Artifact Awards
<br><br>
...
## (F09) Authors of papers with accepted artifacts benefit from five more minutes of presentation at the conference
...
> In this edition of the conference, papers associated to accepted replication packages benefit from five more minutes of presentation at the conference, an extra page dedicated to the presentation of the replication package in the conference proceedings, and the replication package itself stored on the ACM digital library.

[Direct link](https://dl.acm.org/action/showFmPdf?doi=10.1145%2F2786805) - 
[PDF](FSE-websites/FSE2015-FM.pdf) <br>
Breadcrumb: ACM Digital Library > ESEC/FSE 2015 > Proceeding Downloads > Front matter
<br><br>
...
## (F10) CfA states that accepted artifacts are stored in the ACM Digital Library
...
## (F11) CfA states that papers with accepted artifacts benefit from an extra page dedicated to the presentation of the artifacts
...
## (F12) CfA states that abstracts documenting accepted artifacts are to be published in the proceedings
...
## (F13) CfA states that authors of artifacts accepted as Results Validated are invited to give lightning talks
...
[Direct link](https://2020.esec-fse.org/track/esecfse-2020-artifacts) - 
[PDF](FSE-websites/FSE2020-AT.pdf) <br>
Breadcrumb: ESEC/FSE 2020 > Tracks > Artifacts > Submission and Review > For Replicated and Reproduced Badges
<br><br>
...
[Direct link](https://2021.esec-fse.org/track/fse-2021-artifacts) - 
[PDF](FSE-websites/FSE2021-AT.pdf) <br>
Breadcrumb: ESEC/FSE 2021 > Tracks > Artifacts > Submission Instructions and Reviewing Guidelines > Submission Instructions and Reviewing Guidelines
<br><br>
...
[Direct link](https://2022.esec-fse.org/track/fse-2022-artifacts) - 
[PDF](FSE-websites/FSE2022-AT.pdf) <br>
Breadcrumb: ESEC/FSE 2022 > Tracks > Artifacts > Call for Submissions > Badges for Replicated or Reproduced Papers
<br><br>
...
[Direct link](https://2022.esec-fse.org/track/fse-2022-artifacts) - 
[PDF](FSE-websites/FSE2022-AT.pdf) <br>
Breadcrumb: ESEC/FSE 2022 > Tracks > Artifacts > Call for Submissions > Submission for Replicated and Reproduced Badges
<br><br>
...
>
> - If time permits, the submitters will be invited to give short talks on this work at ESEC/FSE’23. This will be subject to the availability of time in the conference program. 

[Direct link](https://2023.esec-fse.org/track/fse-2023-artifacts) - 
[PDF](FSE-websites/FSE2023-AT.pdf) <br>
Breadcrumb: ESEC/FSE 2023 > Tracks > Artifacts > Call for Submissions > Badges for Replicated or Reproduced Papers
<br><br>
...
[Direct link](https://2023.esec-fse.org/track/fse-2023-artifacts) - 
[PDF](FSE-websites/FSE2023-AT.pdf) <br>
Breadcrumb: ESEC/FSE 2023 > Tracks > Artifacts > Call for Submissions > Submission for Replicated and Reproduced Badges
<br><br>
...
## (F14) CfA states that authors of artifacts accepted as Artifact Evaluated may be invited to give lightning talks
...
## (F15) Research track CfP asks authors not to provide URLs to author-revealing sites due to the double-anonymous review process
...
[PDF](FSE-websites/FSE2017-RT.pdf) <br>
...
[PDF](FSE-websites/FSE2018-RT.pdf) <br>
...
[PDF](FSE-websites/FSE2019-RT.pdf) <br>
...
[PDF](FSE-websites/FSE2020-RT.pdf) <br>
...
[PDF](FSE-websites/FSE2021-RT.pdf) <br>
...
[PDF](FSE-websites/FSE2022-RT-About.pdf) <br>
...
[PDF](FSE-websites/FSE2023-RT-CfP.pdf) <br>
Breadcrumb: ESEC/FSE 2023 > Tracks > Research Papers > Call for Papers > Double-Anonymous Review Process
<br><br>


> To conform to the double-anonymous policy, please include an anonymized URL. Code and data repositories may be exported to remove version control history, scrubbed of names in comments and metadata, and anonymously uploaded to a sharing site. Instructions are provided in the ESEC/FSE open science policy.

[Direct link](https://2023.esec-fse.org/track/fse-2023-research-papers?#FAQ) - 
[PDF](FSE-websites/FSE2023-RT-FAQ.pdf) <br>
Breadcrumb: ESEC/FSE 2023 > Tracks > Research Papers > FAQ > FAQ on Review Process: Major Revisions, Open Science Policy, Double-Anonymous Reviewing > Open Science Policy
<br><br>

---


## (F16) Research track CfP states that authors can submit an additional file containing supplementary material
...
> You can submit, optionally, an additional file containing supplementary material (see details below). 
> 
> [...]
>
> ESEC/FSE 2018 will employ a lightweight double-blind review process. The papers submitted must not reveal the authors’ identities in any way: [...]
...
> Upon submission to the research track, authors are asked to make a replication package available to the program committee (via upload of supplemental material or a link to a private or public repository) or to comment on why this is not possible or desirable.
...
## (F17) Research track CfP encourages authors to submit a link to anonymous artifacts
...
## (F18) Research track CfP encourages authors to make artifacts available upon paper submission or explain why not
...
> Upon submission to the research track, authors are asked to:
>
...
[Direct link](https://2022.esec-fse.org/track/fse-2022-research-papers#FAQ) - 
[PDF](FSE-websites/FSE2022-RT-FAQ.pdf) <br>
Breadcrumb: ESEC/FSE 2022 > Tracks > Research Papers > FAQ > FAQ on Review Process and Double-Anonymous Reviewing > Open Science Policy
<br><br>
...
> - Open Science Policy: ESEC/FSE has adopted the SIGSOFT Open Science Policy and the Call for Papers encouraged the authors to provide also a replication package, requesting all authors to either provide a supporting statement on the availability of a replication package, or to comment on why this is not possible or desirable, in a dedicated section, named Data Availability.

[Direct link](https://dl.acm.org/action/showFmPdf?doi=10.1145%2F3611643) - 
[PDF](FSE-websites/FSE2023-FM.pdf) <br>
Breadcrumb: ACM Digital Library > ESEC/FSE 2023 > Proceeding Downloads > Front matter
<br><br>
...
## (F19) FSE asks authors to declare artifact availability in the papers, ideally, in a section named Data Availability
...
[PDF](FSE-websites/FSE2019-OpenScienceGuidelines.pdf) <br>
...
[PDF](FSE-websites/FSE2020-OpenScienceGuidelines.pdf) <br>
...
[PDF](FSE-websites/FSE2021-OpenScienceGuidelines.pdf) <br>
...
[PDF](FSE-websites/FSE2023-OpenSciencePolicies.pdf) <br>
...
## (F20) Research track CfP states that reviewers will not necessarily consider any materials in the paper review process
...
## (F21) Open Science policies are provided on the FSE website
...
In ESEC/FSE 2022 edition the Open Science Guidelines are not presented on the website. The Open Science Policy is just mentioned in the CFP of the Research Papers without any link:

> For more details on ESEC/FSE open science policy, please refer to the official guidelines.
...
## (F22) FSE adheres to the ACM SIGSOFT Open Science Policies
...
## (F23) FSE provides a guide to disclose data for double-anonymous peer review and make it open upon paper acceptance
...
## (F24) FSE provides a guide to automatically archive a GitHub repository to Zenodo or Figshare
...
## (F25) FSE hosts a ROSE Festival edition
...
[PDF](FSE-websites/FSE2018-ROSE.pdf) <br>
...
> This year we have added the ROSE Festival to the conference, which aims to recognize and reward open science in Software Engineering.

[Direct link](https://dl.acm.org/action/showFmPdf?doi=10.1145%2F3236024) - 
[PDF](FSE-websites/FSE2018-FM.pdf) <br>
Breadcrumb: ACM Digital Library > ESEC/FSE 2018 > Proceeding Downloads > Front matter
<br><br>
...
> ROSE Festival #3
>
> A track at ESEC/FSE 2019, August 29, 2019.

[Direct link](https://esec-fse19.ut.ee/rose-festival/) - 
[PDF](FSE-websites/FSE2019-ROSE.pdf) <br>
Breadcrumb: ESEC/FSE 2019 > Program > ROSE Festival
<br><br>
...
[Direct link](https://2023.esec-fse.org/track/fse-2023-rose-festival--rewarding-open-science-replication-and-reproduction-in-se-) - 
[PDF](FSE-websites/FSE2023-ROSE.pdf) <br>
Breadcrumb: ESEC/FSE 2023 > Tracks > ROSE Festival
<br><br>
...
[^1]: The websites of FSE 2014, 2015 and 2016 are not available online. We accessed an archived version of these websites at [Wayback Machine](https://web.archive.org/)